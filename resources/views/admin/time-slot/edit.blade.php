            ...
            <form class="needs-validation" novalidate action="{{route($route.'.update', $row->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="slot_limit" id="slot_limit" value="{{$row->slot_limit }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" name="start_time" id="start_time" value="{{$row->booking_from_time }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" name="end_time" id="end_time" value="{{$row->booking_to_time}}" required>
