                ...
                <form class="needs-validation" novalidate action="{{ route($route.'.store') }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="title">{{ trans_choice('dashboard.module_page', 1) }}
                                {{ __('dashboard.title') }} <span>*</span></label>
                        ...
                        <div class="form-group">
                            <label for="meta_title-">{{ __('dashboard.meta_title') }}:
                                <span>{{ __('dashboard.meta_title_length') }}</span></label>
                            <textarea class="form-control" name="meta_title" id="meta_title-" rows="1"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="description-">{{ __('dashboard.meta_description') }}:
                                <span>{{ __('dashboard.meta_desc_length') }}</span></label>
                            <textarea class="form-control" name="description" id="description-" rows="1"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="keywords-">{{ __('dashboard.focus_keywords') }}:
                                <span></span></label>
                            <textarea class="form-control" name="keywords" id="keywords-" rows="1"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="keywords-">{{ __('dashboard.secondary_keywords') }}:
                                <span>{{ __('dashboard.secondary_separate') }}</span></label>
                            <textarea class="form-control" name="secondary_keywords" id="keywords-" rows="1"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="description">{{ __('dashboard.description') }} <span>*</span></label>
                            <textarea class="form-control textMediaEditor" name="description" id="description" rows="8"
