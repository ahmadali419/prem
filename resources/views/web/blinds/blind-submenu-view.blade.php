        ...
        <div class="row">
            <div class="col-lg-12 mb-5 mt-5">
                <div class="row">
                    <div class="col-md-12">
                        @if(!empty($header))
                        <span><a href="{{route('header-submenu.single',$header[0]->title)}}" class="p-3"><i class="fa fa-arrow-left  header-arrow mr-2"></i><span class="prem_text">{{strtoUpper($title)}}</span></a></span>
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 main_div">
                                <a type="button" onclick="getSubmenu('{{$obj->slug_c_title}}')">
                                    <div class="card mb-1">
                                        <div class="card-body">
                                            <span><img src="{{asset('uploads/icons/'.$obj->c_image)}}" alt=""></span>
                                        </div>
                                    </div>
                                </a>
                                <p><a type="button" class="mt-3" onclick="getSubmenu('{{$obj->slug_title}}')"
                                        class="menu_title">{{$obj->sub_c_title}}</a>
                                </p>
                            </div>
                            @endforeach
                        </div>
