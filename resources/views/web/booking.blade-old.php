                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-6">
                                                <table class="table confirmation_table" style="text-align: left;">
                                                    ...
                                                    <tr>
                                                        <td id="first_name_show">2011-11-12</td>
                                                        <td id="last_name_show">2:36 pm - 5:38 am</td>
                                                        <td id="email_show">Blackout Blinds</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Phone Number</th>
                                                    ...
                                                    <tr>
                                                        <td id="phone_number_show">2011-11-12</td>
                                                        <td colspan="2" id="address_show">2:36 pm - 5:38 am</td>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="3">Message</th>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3" id="message_show">This is address</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
...
@section('page-level-js')
    ...
    <script type="text/javascript">
        ...
        function save_booking() {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('save_booking')}}", // your php file name
                data: formData,
                dataType: "json",
 ...
 $(document).on('change','#date_slot',function () {
     ...
     $.ajax({
         type: "GET",
         url: "{{url('https://dev.orderfulfillment.premiumblindsuk.com/public/api/zip-code/get-zip-code-time-slots')}}", // your php file name
         data: {
             "_token": "{{ csrf_token() }}",
             "zip_code": zip_code,
             "date_slot": date_slot,
